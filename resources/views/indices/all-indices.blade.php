    ...
    <div x-data="setup()">
        ...
        <div class="relative">
            ...
            <input x-model="searchInput" type="search" id="default-search"
                ...
                placeholder="Search by index name..." required>
            <button type="submit"
        ...
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <template x-for="index in filterIndices" :key="index.uuid">
    ...
    <script>
        function setup() {
            return {
                ...
                perPage: 5,
                filterIndices() {
                    return this.indices.filter(index => index.index.includes(this.searchInput)).slice((this.currentPage *
